...
abstract class RaxanUIElement extends RaxanElement {
    ...
    /**
     *
     * @param string $id UI Element Id
     * @param mixed $properties Optional. An array or ui Element properties, a RaxanDOMDocument or a RaxanWebPage object
     */
...
abstract class RaxanUIContainer extends RaxanUIElement {
     ...
     * @param array $opt Optional. Set jQuery Tools overlay plugin
    ...
    /**
     * Make component resizeable
     * @param array $opt Optional. See jQuery Resizable plugin
     * @return RaxanUIContainer
     */
